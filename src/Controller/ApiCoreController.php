...
class ApiCoreController extends AbstractController
{
    ...
    /**
     * @Route("/agent_work/{date}/{agent}")
     * @param $date
     * @param string $agent
     * @param CallsRepository $callsRepository
     * @return JsonResponse
     */
    public function agent_work($date,string $agent,CallsRepository $callsRepository):JsonResponse{
        $data = $callsRepository->agent_work($date,$agent);
        return $this->json($data);
    }
    ...
    /**
     * @Route("/rejected_calls_log")
     * @param CallsRepository $callsRepository
     * @return JsonResponse
     */
    public function rejected_calls_log(CallsRepository $callsRepository):JsonResponse{
        $data = $callsRepository->rejected_calls_log();
        return $this->json($data);
    }
